    ...
    <div className='col-span-1 md:col-span-2 lg:col-span-3 h-[72px] bg-black flex items-center text-white relative justify-between'>
      ...
      <div className='flex flex-col items-center gap-2 absolute left-2/4 -translate-x-2/4 w-[608px]'>
        ...
        <div className='flex justify-center items-center gap-2'>
          ...
          <button onClick={previous} className='h-8 w-8 flex justify-center items-center hover:scale-[1.04]'>
            <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" className="h-4 fill-[#b3b3b3] hover:fill-white"><path d="M3.3 1a.7.7 0 0 1 .7.7v5.15l9.95-5.744a.7.7 0 0 1 1.05.606v12.575a.7.7 0 0 1-1.05.607L4 9.149V14.3a.7.7 0 0 1-.7.7H1.7a.7.7 0 0 1-.7-.7V1.7a.7.7 0 0 1 .7-.7h1.6z"></path></svg>
          </button>
          {/* -------- play and pause -------- */}
          <div className='h-8 -w-24 px-2'>
            {
              isPlaying
              ? <button onClick={pause} className='bg-white h-8 w-8 rounded-full flex justify-center items-center hover:bg-[#f0f0f0] hover:scale-[1.04]'>
              ...
              : <button onClick={play} className='bg-white h-8 w-8 rounded-full flex justify-center items-center hover:bg-[#f0f0f0] hover:scale-[1.04]'>
          ...
          <button onClick={next} className='h-8 w-8 flex justify-center items-center hover:scale-[1.04]'>
            <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" className="h-4 fill-[#b3b3b3] hover:fill-white"><path d="M12.7 1a.7.7 0 0 0-.7.7v5.15L2.05 1.107A.7.7 0 0 0 1 1.712v12.575a.7.7 0 0 0 1.05.607L12 9.149V14.3a.7.7 0 0 0 .7.7h1.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7h-1.6z"></path></svg>
          </button>
          <button className='h-8 w-8 flex justify-center items-center cursor-default	'>
      ...
      <div className='hidden min-[1326px]:flex justify-end items-center absolute right-0'>
        ...
        <button className='h-8 w-8 flex justify-center items-center cursor-default green-dot'>
          <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" className="h-4 fill-[#1db954]"><path d="M15 15H1v-1.5h14V15zm0-4.5H1V9h14v1.5zm-14-7A2.5 2.5 0 0 1 3.5 1h9a2.5 2.5 0 0 1 0 5h-9A2.5 2.5 0 0 1 1 3.5zm2.5-1a1 1 0 0 0 0 2h9a1 1 0 1 0 0-2h-9z"></path></svg>
        </button>
        <button className='h-8 w-8 flex justify-center items-center cursor-default'>
        ...
        <button className='h-8 w-8 flex justify-center items-center -mr-[6px] cursor-default'>
        ...
        <Volumebar />
        <button className='ml-[2px] h-8 w-8 flex justify-center items-center cursor-default'>
