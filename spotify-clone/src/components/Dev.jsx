...
const Dev = (
  ...
  return (
    <menu className='rounded bg-[#282828] p-1 mt-6 ml-6 flex flex-col w-fit'>
      <li>
        <button className='hover:bg-[rgba(255,255,255,0.1)] text-sm text-[#eaeaea] flex justify-between items-center gap-3 p-3 pr-2 cursor-default'>
